...
final class ExcursionsListDisplayDataFactory: ExcursionsListDisplayDataFactoryProtocol {
    func setExcursionsListDisplayData() -> [Excursion] {
        let e1 = Excursion(image: UIImage(named: "picture")!, title: "Интересная Москва", rating: 5.0, parameters: "2 часа | 3 км | 6 точек")
        ...
        let e5 = Excursion(image: UIImage(named: "picture")!, title: "Обзорная", rating: 4.8, parameters: "2 часа | 3 км | 6 точек")
